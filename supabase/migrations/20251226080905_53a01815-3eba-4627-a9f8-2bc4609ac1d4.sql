-- Fix ambiguous column references in get_top_recommendations_v2
...
BEGIN
    ...
    scored_titles AS (
        SELECT 
            tuemc.title_id AS scored_title_id,
        ...
        LEFT JOIN social_recs sr ON sr.social_title_id = tuemc.title_id
        WHERE tuemc.user_emotion_id = v_user_emotion_id
          AND NOT EXISTS (SELECT 1 FROM user_excluded ue WHERE ue.excluded_title_id = tuemc.title_id)
