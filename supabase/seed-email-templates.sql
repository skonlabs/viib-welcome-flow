...
-- Activation Code Invitation Template
(
  'activation_invite',
  'Your ViiB Activation Code',
  '<html><head><style>body { font-family: -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, sans-serif; } .container { max-width: 600px; margin: 0 auto; padding: 20px; } .header { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; } .content { background: #ffffff; padding: 40px; border: 1px solid #e5e7eb; border-top: none; } .code-box { background: #f3f4f6; border: 2px dashed #667eea; padding: 20px; margin: 30px 0; text-align: center; border-radius: 8px; } .code { font-size: 32px; font-weight: bold; letter-spacing: 4px; color: #667eea; font-family: ''Courier New'', monospace; } .button { display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 8px; margin: 20px 0; font-weight: bold; } .footer { background: #f9fafb; padding: 20px; text-align: center; color: #6b7280; font-size: 14px; border-radius: 0 0 10px 10px; }</style></head><body><div class="container"><div class="header"><h1 style="margin: 0; font-size: 28px;">Welcome to ViiB! 🎉</h1></div><div class="content"><h2 style="color: #1f2937; margin-top: 0;">You''ve Been Invited!</h2><p style="color: #4b5563; font-size: 16px; line-height: 1.6;">Someone has invited you to join ViiB - your personalized entertainment companion. Use the activation code below to get started on your journey.</p><div class="code-box"><div style="color: #6b7280; font-size: 14px; margin-bottom: 10px;">YOUR ACTIVATION CODE</div><div class="code">{{code}}</div></div><p style="color: #4b5563; font-size: 16px; line-height: 1.6;">To activate your account:</p><ol style="color: #4b5563; font-size: 16px; line-height: 1.8; padding-left: 20px;"><li>Visit the ViiB app</li><li>Click "Get Started" or "Sign Up"</li><li>Enter your activation code when prompted</li><li>Complete your profile setup</li></ol><div style="text-align: center;"><a href="{{app_url}}" class="button">Get Started Now</a></div><p style="color: #9ca3af; font-size: 14px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">This activation code is unique to you. Please don''t share it with others.</p></div><div class="footer"><p style="margin: 0;">© 2024 ViiB. All rights reserved.</p><p style="margin: 10px 0 0 0;">Discover content that matches your vibe.</p></div></div></body></html>',
  'transactional',
  '{"code": "string", "email": "string", "app_url": "string"}',
  true
)
